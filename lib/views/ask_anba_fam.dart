...
class AsKAnbaFamView extends StatefulWidget {
  const AsKAnbaFamView({super.key});

  @override
  State<AsKAnbaFamView> createState() => _AsKAnbaFamViewState();
}

class _AsKAnbaFamViewState extends State<AsKAnbaFamView> {
                            ...
                            : CustomButtonSend(
                                onTap: () {
                                  if (formKey.currentState!.validate()) {
                                    ...
                                    context.read<QuestionCubit>().submitQuestion(name!, content!,"AnbaFam");
                                  }
                                },
                                title: 'ارسل السؤال',
                              ),
